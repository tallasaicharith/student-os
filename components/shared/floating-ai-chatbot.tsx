        ...
        <AnimatePresence>
          {!isOpen && (
            <motion.button
              ...
              className="flex items-center gap-2 bg-gradient-to-r from-indigo-600 to-purple-600 text-white px-4 py-3 rounded-full shadow-2xl hover:shadow-indigo-500/25 border border-white/20 backdrop-blur-md"
            >
              <Sparkles className="w-5 h-5 animate-spin [animation-duration:4s]" />
              <span className="text-xs font-bold tracking-wide">StudentOS AI</span>
            </motion.button>
          )}
        </AnimatePresence>
      </div>
            ...
            <div className="p-3 border-b bg-muted/40 flex items-center justify-between">
              <div className="flex items-center gap-2">
                ...
                <div>
                  ...
                  <span className="text-[9px] text-emerald-500 font-semibold block">● Online (LangChain Powered)</span>
                </div>
              </div>
              <Button
                variant="ghost"
